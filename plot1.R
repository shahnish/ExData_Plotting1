...
# Plot1 is histogram of Global Active Power (killowatts)
# First plot on screen and make sure it looks like assignement
hist(subsetData$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (killowatts)", ylab="Frequency")
